...
import com.example.sightsee.fragment.TourFragment;
...
public class TourActivity extends AppCompatActivity {
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position){
                case 0:
                    tp = TourFragment.newInstance(R.layout.tour_fragment_1);
                    break;
                case 1:
                    tp = TourFragment.newInstance(R.layout.tour_fragment_2);
                    break;
                case 2:
                    tp = TourFragment.newInstance(R.layout.tour_fragment_3);
                    break;
                case 3:
